...
const FAQ = () => {
  ...
  return (
    <>
    <h2 className="text-headline-2 tablet:px-20 font-black font-inter mb-4 mt-20 md:px-32 sm:mx-5 sm:text-subheadline-2 text-white">Frequently Asked Questions</h2>
    <div className="md:mx-32 tablet:px-20 p-4">
